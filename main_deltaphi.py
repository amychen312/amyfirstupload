...
def main(args):  
    ...
    train_loader, test_loader = get_rag_dataloader(x_train, y_train, x_test, y_test,  batch_size = batch_size, rag_configs = { "training_refer_range": 20, "refer_num": 1 }, train_shuffle=False )
